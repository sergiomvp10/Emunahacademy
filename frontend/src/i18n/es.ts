export const es = {
  ...
  progress: {
    ...
    print: 'Imprimir',
    projectedCompletion: 'Finalizacion Proyectada',
    stepsLeftToMeetGoal: 'pasos para cumplir la meta',
    completedLabel: 'Completado',
    gpa: 'GPA',
    timeSpentThisWeek: 'Tiempo Dedicado esta Semana',
    timeSpentSubtitle: 'Porcentaje de tiempo por materia',
